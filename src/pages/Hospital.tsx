      ...
      <div className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 mb-12">
            ...
            <p className="text-gray-700 mb-3">
              La maison dite "de la Roselierre", à Fontaines-sur-Saône (Rhône), est le lieu d'habitation de la famille Rigot. Lorsque la guerre éclate en 1914, Ernest Rigot, âgé de 37 ans, est célibataire et est le propriétaire de la maison.
